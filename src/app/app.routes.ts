...
import { TermosepoliticasComponent } from './components/sistema/termosepoliticas/termosepoliticas.component';
...
export const routes: Routes = [
  ...
  {path: 'termosepoliticas', component: TermosepoliticasComponent},
